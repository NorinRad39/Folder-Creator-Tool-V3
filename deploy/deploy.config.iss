...
#define AppName "Folder-Creator-Tool-V3"
...
; AssemblyName du csproj ("Folder Creator Tool V3", avec espaces) ne correspond pas a
; AppSlug : ExeName ne peut donc pas se deriver de AppSlug.
#define ExeName "Folder Creator Tool V3.exe"
...
; litterale.
#define AppId "{{CD137936-0CF8-421D-9765-66A8941C2028}"
...
#define IconFile "..\icône pour une application de classement de fichiers 3D et de plans avec un robot et des dossiers.ico"
